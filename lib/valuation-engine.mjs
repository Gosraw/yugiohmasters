...
/**
 * Maps a draft-value score (0-10) to a proposed rarity band.
 * Rarity means "how desirable is this to be randomly offered",
 * NOT raw theoretical power - see the Season 1 review. Bands
 * intentionally steep at the top (Legendary/Secret Rare are meant
 * to be rare in COUNT) - these are a starting point, not tuned
 * against the real catalog yet (that step is explicitly deferred -
...
export const VALUATION_ENGINE_VERSION = "2026-08-23.2";
