-- =========================================================
-- PHASE 1 DEPLOYMENT - SECTION 02 of 08
-- 2015-2018 curated legacy-support whitelist (15 cards). Depends on
-- duelist_circle_classic_v1 existing; if it does not exist yet, this
-- section's inserts self-report via RAISE NOTICE and no-op rather
-- than failing. Idempotent: safe to re-run.
-- SOURCE (unmodified): supabase/migrations/202608301200_seed_2015_2018_legacy_support_whitelist.sql
-- =========================================================
