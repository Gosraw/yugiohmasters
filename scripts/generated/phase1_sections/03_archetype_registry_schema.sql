-- =========================================================
-- PHASE 1 DEPLOYMENT - SECTION 03 of 08
-- archetype_registry / archetype_cards TABLE SCHEMA ONLY (no card
-- data yet - that is section 04). Independent. Must run before 04.
-- Idempotent: safe to re-run (CREATE TABLE IF NOT EXISTS).
-- SOURCE (unmodified): supabase/migrations/202608301300_archetype_registry_schema.sql
-- =========================================================
