-- =========================================================
-- PHASE 1 DEPLOYMENT - SECTION 05 of 08
...
-- tiebreak_match_result() that call them. Depends on the existing
-- competitions/matches/competition_reward_grants schema (already
-- live). Idempotent: safe to re-run.
-- SOURCE (unmodified): supabase/migrations/202608301500_round_reward_settlement_and_auto_finalize.sql
-- =========================================================
