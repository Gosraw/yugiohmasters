...
-- =========================================================
-- DUELIST CIRCLE
-- DRAFT: ONE RARITY ROLL PER 3-CARD OFFER
--
-- Flow:
--
-- 1. Bepaal draftfase:
--      Main / Fusion / XYZ
--
-- 2. Bepaal welke rarities minstens 3 geldige
--    beschikbare kaarten kunnen aanbieden.
--
-- 3. Roll 1 rarity volgens de ingestelde weights.
--
-- 4. Kies 3 verschillende kaarten van die rarity.
--
-- 5. De speler kiest 1 van de 3.
--
-- De rarity blijft dus gelijk binnen het hele offer.
-- =========================================================


-- ---------------------------------------------------------
-- 1. SLA DE GEROLDE RARITY OP
-- ---------------------------------------------------------
...
-- ---------------------------------------------------------
-- 2. VALIDATIE VAN RARITY
-- ---------------------------------------------------------

alter table public.draft_offers
drop constraint if exists draft_offers_rolled_rarity_valid;


alter table public.draft_offers
add constraint draft_offers_rolled_rarity_valid
check (
  rolled_rarity is null
  or rolled_rarity in (
    'Normal',
    'Rare',
    'Super Rare',
